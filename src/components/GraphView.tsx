...
export function GraphView({ data, onNodeSelect, onEdgeSelect, selectedPath = [], compact = false, showListOption = true }: { data: GraphData; onNodeSelect?: (node: GraphNode) => void; onEdgeSelect?: (edge: GraphEdge) => void; selectedPath?: string[]; compact?: boolean; showListOption?: boolean }) {
